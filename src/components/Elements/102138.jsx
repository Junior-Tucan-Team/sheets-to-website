...
const view =
  <svg width="290" height="165" viewBox="0 0 290 165" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="28" y="32" width="112" height="47" rx="5" fill="#F0F3FF"/>
    <rect x="151" y="32" width="112" height="47" rx="5" fill="#F0F3FF"/>
    <rect x="28" y="89" width="112" height="47" rx="5" fill="#F0F3FF"/>
    <rect x="151" y="89" width="112" height="47" rx="5" fill="#F0F3FF"/>
    <defs>
