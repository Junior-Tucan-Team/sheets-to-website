        ...
        {/* {item.source.entries.map(entry => {
            ...
            rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0"
              ...
              object-cover object-center mb-6"
                    src={item.source.questions.length ?
                      entry.answers[item.source.questions[0]].answer : null}
                    alt="content"
                  />
                </div>
              ...
              font-medium mb-2"
                  >{item.source.questions.length > 1 ?
                   entry.answers[item.source.questions[1]].answer : null}
                  </h2>
                  <p className="leading-relaxed text-base">
                    {item.source.questions.length > 2 ?
                     entry.answers[item.source.questions[2]].answer : null}
                  </p>
                  <p className="mt-1">{item.source.questions.length > 3
                    ? entry.answers[item.source.questions[3]].answer : null}</p>
                </div>
              </div>);
          })} */}
      </div>
