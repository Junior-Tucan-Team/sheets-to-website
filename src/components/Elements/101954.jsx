...
const view =
  <svg width="290" height="165" viewBox="0 0 290 165" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="99" y="113" width="92" height="6.86552" rx="3.43276" fill="#C4C4C4"/>
    <rect x="111" y="129.478" width="67.0286" height="6.86552" rx="3.43276" fill="#DEDEDE"/>
    <rect x="28" y="29" width="69" height="60" rx="5" fill="#F0F3FF"/>
    <rect x="110" y="29" width="69" height="60" rx="5" fill="#F0F3FF"/>
    <rect x="194" y="29" width="69" height="60" rx="5" fill="#F0F3FF"/>
    <defs>
