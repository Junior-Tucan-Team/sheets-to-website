...
const view =
  <svg width="290" height="165" viewBox="0 0 290 165" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="28" y="75" width="58.8" height="6.86552" rx="3.43276" fill="#C4C4C4"/>
    <rect x="28" y="91.4775" width="42.84" height="6.86552" rx="3.43276" fill="#DEDEDE"/>
    <rect x="28" y="108" width="51.7696" height="7" rx="3.5" fill="#DEDEDE"/>
    <rect x="115.8" y="75" width="58.8" height="6.86552" rx="3.43276" fill="#C4C4C4"/>
    <rect x="115.8" y="91.4775" width="42.84" height="6.86552" rx="3.43276" fill="#DEDEDE"/>
    <rect x="115.8" y="108" width="51.7696" height="7" rx="3.5" fill="#DEDEDE"/>
    <rect x="203.6" y="75" width="58.8" height="6.86552" rx="3.43276" fill="#C4C4C4"/>
    <rect x="203.6" y="91.4775" width="42.84" height="6.86552" rx="3.43276" fill="#DEDEDE"/>
    <rect x="203.6" y="108" width="51.7696" height="7" rx="3.5" fill="#DEDEDE"/>
    <rect x="28" y="50" width="33" height="7" rx="3.5" fill="#C4C4C4"/>
    <rect x="115" y="50" width="34" height="7" rx="3.5" fill="#C4C4C4"/>
    <rect x="204" y="50" width="33" height="7" rx="3.5" fill="#C4C4C4"/>
    <defs>
