...
const view =
  <svg width="290" height="165" viewBox="0 0 290 165" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="82" y="121" width="35" height="5.52632" rx="2.76316" fill="#C4C4C4"/>
    <rect x="75" y="130.474" width="49" height="5.52632" rx="2.76316" fill="#DEDEDE"/>
    <rect x="74" y="52" width="51" height="60" rx="5" fill="#F0F3FF"/>
    <rect x="173" y="121" width="35" height="5.52632" rx="2.76316" fill="#C4C4C4"/>
    <rect x="166" y="130.474" width="49" height="5.52632" rx="2.76316" fill="#DEDEDE"/>
    <rect x="165" y="52" width="51" height="60" rx="5" fill="#F0F3FF"/>
    <defs>
