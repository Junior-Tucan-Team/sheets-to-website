...
const view =
  <svg width="290" height="165" viewBox="0 0 290 165" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="64" y="49" width="162" height="6.86552" rx="3.43276" fill="#C4C4C4"/>
    <rect x="85.1309" y="75" width="118.029" height="6.86552" rx="3.43276" fill="#DEDEDE"/>
    <rect x="107" y="108.522" width="74" height="7" rx="3.5" fill="#DEDEDE"/>
    <rect x="75" y="91.5225" width="138" height="7" rx="3.5" fill="#DEDEDE"/>
    <defs>
