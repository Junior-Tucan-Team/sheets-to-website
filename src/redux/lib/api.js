...
export const getFormSubmissions = async (formID) => (axios.get('https://api.jotform.com/user/submissions?apiKey=480339cbba3edb9e8cd1e82ee8bfafec')
.then((res) => res.data.content)
.then((res) => res.filter((e) => e.form_id === formID)));
